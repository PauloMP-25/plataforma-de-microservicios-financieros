...
import { GastoReciente } from '../../types/gastos.interfaces';

@Component({
  selector: 'app-gasto-recent-list',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './gasto-recent-list.html',
})
export class GastoRecentListComponent {
  @Input() items: GastoReciente[] = [];
  ...
  get itemsPaginados(): GastoReciente[] {

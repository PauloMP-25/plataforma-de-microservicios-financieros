 ...
 * Almacena los códigos OTP de 6 dígitos asociados a un usuario específico.
 * Vigencia por defecto: 10 minutos (configurable).
 *
...
public class CodigoVerificacion {
    ...
    /**
     * Identificador del usuario en el Microservicio-Usuario.
     * Campo OBLIGATORIO: todo código debe estar ligado a un usuario del sistema.
     */
    ...
    /**
     * Valida el código ingresado contra el almacenado.
     * Retorna true únicamente si no está usado, no expiró y los valores coinciden.

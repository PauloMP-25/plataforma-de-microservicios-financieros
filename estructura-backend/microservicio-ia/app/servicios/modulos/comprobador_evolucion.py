...
class ComprobadorEvolucion:
    ...
    def orquestar_prompt(self, metricas: Dict[str, Any], contexto) -> str:
        ...
        [FICHA DEL PACIENTE]
        Nombre: {contexto.nombre_display if hasattr(contexto, 'nombre_display') else 'Paciente'}
        ...
        Debes entregar tu diagnóstico en dos partes claramente separadas:
        
        1. VEREDICTO NARRATIVO: Justifica la clasificación diagnóstica ("{metricas['diagnostico_imf']}") en un máximo de cuatro oraciones usando lenguaje clínico accesible y motivador. No uses lenguaje de máquina, háblale directamente al paciente.
        
        2. RECETA MÉDICA DIGITAL: 
        Para las "Fracturas Detectadas" (si las hay), receta exactamente 3 acciones específicas, numéricas y medibles que el paciente debe implementar esta semana para sanar esas categorías. 
        Si no hay fracturas, receta 3 acciones de mantenimiento avanzado para sostener su "Salto Cualitativo".
        
        Firma al final como "Dr. Luka Coach, Especialista en Salud Financiera".
        """
        return prompt

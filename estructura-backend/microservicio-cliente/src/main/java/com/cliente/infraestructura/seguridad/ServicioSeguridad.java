...
public class ServicioSeguridad {
    ...
    public boolean esServicioInterno() {
        ...
        if (auth != null && auth.isAuthenticated()) {
            return auth.getAuthorities().stream()
                    .anyMatch(a -> "ROLE_SYSTEM".equals(a.getAuthority()) || "ROLE_ADMIN".equals(a.getAuthority()));
        }
        return false;
    }
     ...
     * <p>
     * Nota: En esta versión robusta, delegamos completamente en la autenticación
     * del contexto de seguridad ('ROLE_SYSTEM' inyectado tras validar X-Internal-Token).
     * Mantenemos este método para compatibilidad de firma con llamadas existentes.
     * </p>
     * 

...
/**
 * Propiedades centralizadas y validadas para la gestión de tokens JWT en el microservicio-cliente.
 * Evita fallos en caliente validando las claves en el arranque de la aplicación.
 */
@Getter
@Setter
@Validated

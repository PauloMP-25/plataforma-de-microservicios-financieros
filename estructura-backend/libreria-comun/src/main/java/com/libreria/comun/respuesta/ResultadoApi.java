 ...
 * @param error Etiqueta semántica del error (ej. "USUARIO_NO_REGISTRADO").
...
public record ResultadoApi<T>(
    ...
    public static <T> ResultadoApi<T> exito(T datos, String mensaje) {
        return new ResultadoApi<>(true, 200, null, mensaje, datos, null, null, LocalDateTime.now());
    }
    ...
    public static <T> ResultadoApi<T> creado(T datos, String mensaje) {
        return new ResultadoApi<>(true, 201, null, mensaje, datos, null, null, LocalDateTime.now());
    }
    ...
    public static ResultadoApi<Void> aceptado(String mensaje) {
        return new ResultadoApi<>(true, 202, null, mensaje, null, null, null, LocalDateTime.now());
    }
    ...
    public static ResultadoApi<Void> sinContenido(String mensaje) {
        return new ResultadoApi<>(true, 204, null, mensaje, null, null, null, LocalDateTime.now());
    }
    ...
    public static <T> ResultadoApi<T> falla(CodigoError cod, String mensaje, String ruta) {
        return new ResultadoApi<>(false, cod.getStatus().value(), cod.name(), mensaje, null, null, ruta, LocalDateTime.now());
    }
     ...
     */
    public static <T> ResultadoApi<T> fallaConDetalles(CodigoError cod, String mensaje, String ruta, List<String> detalles) {
        return new ResultadoApi<>(false, cod.getStatus().value(), cod.name(), mensaje, null, detalles, ruta, LocalDateTime.now());
    }
    ...
    public static <T> ResultadoApi<T> falla(int estado, String error, String mensaje, String ruta) {
        return new ResultadoApi<>(false, estado, error, mensaje, null, null, ruta, LocalDateTime.now());
    }
     ...
     */
    public static <T> ResultadoApi<T> fallaConDetalles(int estado, String error, String mensaje, String ruta, List<String> detalles) {
        return new ResultadoApi<>(false, estado, error, mensaje, null, detalles, ruta, LocalDateTime.now());
    }
}

...
// ══════════════════════════════════════════════════════════════════════════════
/**
 * DTO de entrada para registrar un evento de acceso (login/logout). Lo envía el
 * microservicio-usuario o el api-gateway.
 */
public record AuditoriaAccesoRequestDTO(
    ...
    public static AuditoriaAccesoRequestDTO of(UUID usuarioID, String ipOrigen, String navegador, EstadoAcceso estado, String detalleError, LocalDateTime fecha) {
        return new AuditoriaAccesoRequestDTO(usuarioID, ipOrigen, navegador, estado, detalleError, fecha);
    }
}
